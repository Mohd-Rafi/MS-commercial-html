...
class SwipeSlider {
  ...
  setIndicator() {
    ...
    this.indicator.style.width = `86px`
  }
  ...
  bindHandlers() {
    ...
    this.indicator.addEventListener("mousedown", (e) => this.handleMouseStart(e));
    this.indicator.addEventListener("mousemove", (e) => this.handleMouseMove(e));
    this.indicator.addEventListener("mouseup", (e) => this.handleEnd(e));
    this.indicator.addEventListener("mouseleave", (e) => this.handleEnd(e));
